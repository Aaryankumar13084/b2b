...
import { RefreshCw, Upload, Download, ArrowLeft, CheckCircle } from "lucide-react";
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">Convert Image</h1>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={targetFormat} onValueChange={setTargetFormat}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="webp">WebP - Best for web</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-green-500/10 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Converted to {targetFormat.toUpperCase()} format
                    </p>
                  </div>
                </div>
