...
import { ImageIcon, Upload, Download, ArrowLeft, CheckCircle } from "lucide-react";
  ...
  const handleCompress = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Reduced by ${data.metadata?.reduction || 0}%`,
      });
    } catch (error: any) {
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">Compress Image</h1>
          ...
          <CardContent>
            ...
            {(uploadState === "uploading" || uploadState === "processing") && (
              <div className="space-y-4">
                ...
                <Progress value={progress} className="h-2" data-testid="progress-compress" />
              </div>
            )}
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-green-500/10 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Reduced by {result.metadata?.reduction || 0}%
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 p-4 bg-muted/50 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="font-semibold">{formatFileSize(result.metadata?.originalSize || 0)}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">Compressed</p>
                    <p className="font-semibold text-green-600 dark:text-green-400">
                      {formatFileSize(result.metadata?.compressedSize || 0)}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-muted-foreground">Saved</p>
                    <p className="font-semibold text-primary">{result.metadata?.reduction || 0}%</p>
                  </div>
                </div>
