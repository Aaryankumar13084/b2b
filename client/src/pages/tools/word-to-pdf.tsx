...
import { FileType, Upload, Download, ArrowLeft, CheckCircle } from "lucide-react";
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">Word to PDF</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Drag and drop your .doc or .docx file or click to browse. Max file size: 50MB
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {file && uploadState === "idle" && (
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
                  <FileType className="w-10 h-10 text-muted-foreground" />
