...
export default function ExcelToCsv() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/tools/excel-to-csv", {
        method: "POST",
        body: formData,
        credentials: "include",
      });
      ...
      if (!response.ok) {
        ...
        throw new Error(error.message || "Failed to convert Excel");
      }
      ...
      toast({
        ...
        description: "Excel file converted to CSV",
      });
    } catch (error: any) {
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">Excel to CSV</h1>
              <p className="text-muted-foreground">Convert Excel spreadsheets to CSV format</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Convert .xlsx or .xls files to comma-separated values
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {(uploadState === "uploading" || uploadState === "processing") && (
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
                  <FileSpreadsheet className="w-10 h-10 text-muted-foreground animate-pulse" />
                  <div className="flex-1">
