...
import { Unlock, Upload, Download, ArrowLeft, CheckCircle } from "lucide-react";
...
export default function PdfUnlock() {
  ...
  const handleUnlock = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/tools/pdf-unlock", {
        method: "POST",
        body: formData,
        credentials: "include",
      });
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">Unlock PDF</h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Upload your locked PDF</CardTitle>
            <CardDescription>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {uploadState === "uploading" ? "Uploading..." : "Decrypting..."}
                    </p>
                  </div>
                </div>
                <Progress value={progress} className="h-2" data-testid="progress-unlock" />
              </div>
            )}
            ...
            {uploadState === "complete" && (
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <Button variant="outline" onClick={resetUpload} data-testid="button-unlock-another">
                    Unlock Another
                  </Button>
                </div>
              </div>
