...
import { Eraser, Upload, Download, ArrowLeft, CheckCircle } from "lucide-react";
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">Remove Background</h1>
              <p className="text-muted-foreground">Remove background from images automatically</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Works best with images that have clear subjects and light backgrounds
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {file && uploadState === "idle" && (
              <div className="space-y-6">
                ...
                <Button onClick={handleRemove} className="w-full" data-testid="button-remove-bg">
                  Remove Background
                </Button>
              </div>
            )}
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {uploadState === "uploading" ? "Uploading..." : "Removing background..."}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-green-500/10 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Output: {result.metadata?.width}x{result.metadata?.height} pixels (PNG)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button variant="outline" onClick={resetUpload} data-testid="button-remove-another">
                    Process Another
                  </Button>
                </div>
              </div>
