  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "PDF tables have been extracted to Excel",
      });
    } catch (error: any) {
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold" data-testid="text-page-title">PDF to Excel</h1>
              <p className="text-muted-foreground">Extract tables from PDF to Excel spreadsheet</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload a PDF containing tables to convert to Excel
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {uploadState === "uploading" ? "Uploading..." : "Extracting tables..."}
                    </p>
                  </div>
                </div>
